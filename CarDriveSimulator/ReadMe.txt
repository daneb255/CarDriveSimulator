========================================================================
    KONSOLENANWENDUNG: CarDriveSimulator-Projektübersicht
========================================================================

Diese Auto-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre CarDriveSimulator-Anwendung besteht.


CarDriveSimulator.vcxproj
...
CarDriveSimulator.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Car.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
